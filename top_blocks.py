...
class top_blocks(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "top_blocks")
        ...
        self.osmosdr_source_1.set_center_freq(434e6, 0)
        ...
        self.osmosdr_source_1.set_if_gain(16, 0)
        self.osmosdr_source_1.set_bb_gain(16, 0)
        self.osmosdr_source_1.set_antenna('', 0)
        self.osmosdr_source_1.set_bandwidth(0, 0)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/kali/Desktop/gnu/record.wav', False)
...
def main(top_block_cls=top_blocks, options=None):
